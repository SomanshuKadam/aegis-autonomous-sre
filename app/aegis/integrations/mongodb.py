...
class MongoStore:
    ...
    def bootstrap(self) -> None:
        self.db.incidents.create_index("dedup_key", unique=True); self.db.timeline.create_index([("incident_id", ASCENDING), ("sequence", ASCENDING)], unique=True); self.db.orders.create_index("idempotency_key", unique=True); self.db.executions.create_index("idempotency_key", unique=True)
