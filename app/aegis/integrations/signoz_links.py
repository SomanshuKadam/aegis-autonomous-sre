...
def trace_link(trace_id: str, service: str, base_url: str = "http://localhost:8080") -> dict[str, str | None]:
...
def context_links(trace_id: str, service: str, base_url: str = "http://localhost:8080") -> dict[str, dict[str, str | None]]:
